	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		t_birthday.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(Register.this, onDateSetListener, mYear, mMonth, mDay).show();
			}
		});
		...
		b_submit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//创建Dialog对话框
				AlertDialog.Builder register_bulider = new AlertDialog.Builder(Register.this)
						.setTitle("注册成功")
						.setMessage("姓名："+name+"\n密码："+password+"\n电话："+phone+"\n性别："+sex+"\n爱好："+ hoppys)
						.setPositiveButton("确定", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								intent.setClass(Register.this,UserActivity.class);
